...
const EXERCISE_DB = [
  // FESSIERS
  {id:"e1",name:"Hip Thrust",target:"glutes",equipment:"barbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Hip_Thrust/0.gif",instructions:["Assieds-toi dos contre un banc, barre sur les hanches","Pousse les hanches vers le haut en contractant les fessiers","Redescends lentement"]},
  {id:"e2",name:"Glute Bridge",target:"glutes",equipment:"body weight",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Glute_Bridge/0.gif",instructions:["Allongé sur le dos, pieds à plat","Pousse les hanches vers le haut","Contracte les fessiers en haut"]},
  {id:"e3",name:"Romanian Deadlift",target:"glutes",equipment:"barbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Romanian_Deadlift/0.gif",instructions:["Debout, barre en main","Descends la barre le long des jambes","Pousse les hanches vers l'arrière"]},
  {id:"e4",name:"Sumo Squat",target:"glutes",equipment:"dumbbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Sumo_Squat/0.gif",instructions:["Pieds écartés, orteils vers l'extérieur","Descends en gardant le buste droit","Pousse sur les talons pour remonter"]},
  {id:"e5",name:"Cable Kickback",target:"glutes",equipment:"cable",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Donkey_Kick/0.gif",instructions:["Attache la cheville au câble","Pousse la jambe vers l'arrière","Contrôle le retour"]},
  {id:"e6",name:"Step Up",target:"glutes",equipment:"dumbbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Step-up/0.gif",instructions:["Monte sur une box avec un pied","Pousse sur le talon pour monter","Redescends lentement"]},
  {id:"e7",name:"Donkey Kick",target:"glutes",equipment:"body weight",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Donkey_Kick/0.gif",instructions:["À quatre pattes","Pousse un genou vers le haut et l'arrière","Contracte le fessier en haut"]},
  {id:"e8",name:"Fire Hydrant",target:"glutes",equipment:"body weight",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Fire_Hydrant/0.gif",instructions:["À quatre pattes","Lève la jambe sur le côté à 90°","Contrôle le retour"]},
  {id:"e9",name:"Hip Abduction",target:"glutes",equipment:"machine",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Hip_Abduction/0.gif",instructions:["Assis sur la machine","Écarte les jambes contre la résistance","Contrôle le retour"]},
  // ISCHIO-JAMBIERS
  {id:"e10",name:"Lying Leg Curl",target:"hamstrings",equipment:"machine",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_Leg_Curl/0.gif",instructions:["Allongé ventre sur la machine","Fléchis les genoux","Redescends lentement"]},
  {id:"e11",name:"Seated Leg Curl",target:"hamstrings",equipment:"machine",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Seated_Leg_Curl/0.gif",instructions:["Assis sur la machine","Fléchis les genoux","Contrôle le retour"]},
  {id:"e12",name:"Stiff Leg Deadlift",target:"hamstrings",equipment:"barbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Stiff-Legged_Deadlift/0.gif",instructions:["Barre en main, jambes légèrement fléchies","Descends en gardant le dos droit","Pousse les hanches vers l'arrière"]},
  {id:"e13",name:"Nordic Curl",target:"hamstrings",equipment:"body weight",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Nordic_Curl/0.gif",instructions:["Genoux au sol, chevilles bloquées","Descends lentement en avant","Utilise les ischio pour freiner"]},
  {id:"e14",name:"Good Morning",target:"hamstrings",equipment:"barbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Good_Morning/0.gif",instructions:["Barre sur les trapèzes","Penche le buste en avant en gardant le dos droit","Remonte en contractant les ischio"]},
  // QUADRICEPS
  {id:"e15",name:"Back Squat",target:"quadriceps",equipment:"barbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Barbell_Squat/0.gif",instructions:["Barre sur les trapèzes","Descends jusqu'à ce que les cuisses soient parallèles","Pousse sur les talons"]},
  {id:"e16",name:"Leg Press",target:"quadriceps",equipment:"machine",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leg_Press/0.gif",instructions:["Assis sur la machine, pieds à largeur d'épaules","Pousse la plateforme","Contrôle le retour"]},
  {id:"e17",name:"Leg Extension",target:"quadriceps",equipment:"machine",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leg_Extension/0.gif",instructions:["Assis, chevilles sous le coussin","Étends les jambes","Redescends lentement"]},
  {id:"e18",name:"Bulgarian Split Squat",target:"quadriceps",equipment:"dumbbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Bulgarian_Split_Squat/0.gif",instructions:["Pied arrière sur un banc","Descends le genou arrière vers le sol","Pousse sur le talon avant"]},
  {id:"e19",name:"Walking Lunge",target:"quadriceps",equipment:"dumbbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Dumbbell_Lunge/0.gif",instructions:["Fente avant en marchant","Genou avant à 90°","Alterne les jambes"]},
  {id:"e20",name:"Front Squat",target:"quadriceps",equipment:"barbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Front_Squat/0.gif",instructions:["Barre sur les deltoïdes avant","Descends en gardant les coudes hauts","Pousse vers le haut"]},
  // DOS
  {id:"e21",name:"Lat Pulldown",target:"back",equipment:"cable",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lat_Pulldown/0.gif",instructions:["Assis à la machine, prise large","Tire la barre vers la poitrine","Contrôle le retour"]},
  {id:"e22",name:"Seated Cable Row",target:"back",equipment:"cable",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Seated_Cable_Row/0.gif",instructions:["Assis, pieds sur les supports","Tire la poignée vers le ventre","Écarte les omoplates"]},
  {id:"e23",name:"Bent Over Row",target:"back",equipment:"barbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Barbell_Row/0.gif",instructions:["Incliné en avant, dos droit","Tire la barre vers le nombril","Serre les omoplates"]},
  {id:"e24",name:"Pull Up",target:"back",equipment:"body weight",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Pull-up/0.gif",instructions:["Suspendu à la barre","Tire jusqu'à ce que le menton dépasse la barre","Redescends lentement"]},
  {id:"e25",name:"Dumbbell Row",target:"back",equipment:"dumbbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Dumbbell_Row/0.gif",instructions:["Un genou sur un banc","Tire l'haltère vers la hanche","Contrôle le retour"]},
  {id:"e26",name:"Face Pull",target:"back",equipment:"cable",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Face_Pull/0.gif",instructions:["Câble à hauteur de visage","Tire vers le visage en écartant les coudes","Contrôle le retour"]},
  // PECTORAUX
  {id:"e27",name:"Bench Press",target:"chest",equipment:"barbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Barbell_Bench_Press/0.gif",instructions:["Allongé sur le banc","Descends la barre vers la poitrine","Pousse vers le haut"]},
  {id:"e28",name:"Incline Dumbbell Press",target:"chest",equipment:"dumbbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Incline_Dumbbell_Press/0.gif",instructions:["Banc incliné à 30-45°","Descends les haltères vers les épaules","Pousse vers le haut"]},
  {id:"e29",name:"Cable Fly",target:"chest",equipment:"cable",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Cable_Crossover/0.gif",instructions:["Câbles en position haute","Amène les poignées vers le centre","Contrôle l'écartement"]},
  {id:"e30",name:"Push Up",target:"chest",equipment:"body weight",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Push-up/0.gif",instructions:["Position planche, mains à largeur d'épaules","Descends la poitrine vers le sol","Pousse pour remonter"]},
  {id:"e31",name:"Dips",target:"chest",equipment:"body weight",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Triceps_Dips/0.gif",instructions:["Suspendu entre deux barres","Descends en fléchissant les coudes","Pousse pour remonter"]},
  // ÉPAULES
  {id:"e32",name:"Overhead Press",target:"shoulders",equipment:"barbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Barbell_Shoulder_Press/0.gif",instructions:["Debout, barre devant les épaules","Pousse la barre au-dessus de la tête","Redescends lentement"]},
  {id:"e33",name:"Lateral Raise",target:"shoulders",equipment:"dumbbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lateral_Raise/0.gif",instructions:["Haltères sur les côtés","Lève les bras à la hauteur des épaules","Contrôle la descente"]},
  {id:"e34",name:"Front Raise",target:"shoulders",equipment:"dumbbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Dumbbell_Front_Raise/0.gif",instructions:["Haltères devant les cuisses","Lève les bras devant toi","Contrôle la descente"]},
  {id:"e35",name:"Arnold Press",target:"shoulders",equipment:"dumbbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Arnold_Press/0.gif",instructions:["Haltères devant les épaules, paumes vers toi","Pivote les poignets en poussant","Redescends en pivotant"]},
  {id:"e36",name:"Upright Row",target:"shoulders",equipment:"barbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Upright_Row/0.gif",instructions:["Barre en prise serrée","Tire vers le menton en écartant les coudes","Contrôle la descente"]},
  // BRAS
  {id:"e37",name:"Barbell Curl",target:"upper arms",equipment:"barbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Barbell_Curl/0.gif",instructions:["Barre en prise supination","Fléchis les coudes","Contrôle la descente"]},
  {id:"e38",name:"Dumbbell Curl",target:"upper arms",equipment:"dumbbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Dumbbell_Curl/0.gif",instructions:["Haltères en prise supination","Fléchis les coudes alternativement","Contrôle la descente"]},
  {id:"e39",name:"Hammer Curl",target:"upper arms",equipment:"dumbbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Hammer_Curl/0.gif",instructions:["Haltères en prise neutre","Fléchis les coudes","Contrôle la descente"]},
  {id:"e40",name:"Tricep Pushdown",target:"upper arms",equipment:"cable",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Triceps_Pushdown/0.gif",instructions:["Câble en haut, coudes collés au corps","Étends les avant-bras vers le bas","Contrôle le retour"]},
  {id:"e41",name:"Skull Crusher",target:"upper arms",equipment:"barbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Skull_Crusher/0.gif",instructions:["Allongé, barre au-dessus de la tête","Fléchis les coudes vers le front","Étends pour remonter"]},
  {id:"e42",name:"Overhead Tricep Extension",target:"upper arms",equipment:"dumbbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Overhead_Triceps_Extension/0.gif",instructions:["Haltère au-dessus de la tête","Fléchis les coudes derrière la tête","Étends vers le haut"]},
  // ABDOMINAUX
  {id:"e43",name:"Plank",target:"abs",equipment:"body weight",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Plank/0.gif",instructions:["Position planche sur les avant-bras","Maintiens le corps aligné","Respire régulièrement"]},
  {id:"e44",name:"Crunch",target:"abs",equipment:"body weight",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Crunch/0.gif",instructions:["Allongé sur le dos, mains derrière la tête","Soulève les épaules vers les genoux","Contrôle la descente"]},
  {id:"e45",name:"Leg Raise",target:"abs",equipment:"body weight",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leg_Raise/0.gif",instructions:["Allongé sur le dos","Lève les jambes tendues à 90°","Redescends lentement"]},
  {id:"e46",name:"Mountain Climber",target:"abs",equipment:"body weight",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Mountain_Climber/0.gif",instructions:["Position planche","Ramène alternativement les genoux vers la poitrine","Garde le dos plat"]},
  {id:"e47",name:"Russian Twist",target:"abs",equipment:"body weight",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Russian_Twist/0.gif",instructions:["Assis, pieds soulevés","Tourne le buste de gauche à droite","Contrôle le mouvement"]},
  {id:"e48",name:"Cable Crunch",target:"abs",equipment:"cable",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Cable_Crunch/0.gif",instructions:["À genoux face au câble","Tire le câble vers les genoux","Contrôle le retour"]},
  // MOLLETS
  {id:"e49",name:"Standing Calf Raise",target:"calves",equipment:"machine",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Standing_Calf_Raise/0.gif",instructions:["Debout sur la machine","Monte sur la pointe des pieds","Descends lentement"]},
  {id:"e50",name:"Seated Calf Raise",target:"calves",equipment:"machine",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Seated_Calf_Raise/0.gif",instructions:["Assis, genoux sous les coussins","Monte sur la pointe des pieds","Descends lentement"]},
  // ADDUCTEURS
  {id:"e51",name:"Hip Adduction",target:"adductors",equipment:"machine",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Hip_Adduction/0.gif",instructions:["Assis sur la machine","Ramène les jambes l'une vers l'autre","Contrôle le retour"]},
  {id:"e52",name:"Sumo Deadlift",target:"adductors",equipment:"barbell",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Sumo_Deadlift/0.gif",instructions:["Pieds très écartés, orteils vers l'extérieur","Descends en gardant le dos droit","Pousse vers le haut"]},
  // POIDS DU CORPS FULL BODY
  {id:"e53",name:"Burpee",target:"abs",equipment:"body weight",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Burpees/0.gif",instructions:["Debout, descends en squat","Saute en position planche","Fais une pompe puis saute vers le haut"]},
  {id:"e54",name:"Jump Squat",target:"quadriceps",equipment:"body weight",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Jump_Squat/0.gif",instructions:["Pieds à largeur d'épaules","Descends en squat","Explose vers le haut"]},
  {id:"e55",name:"Single Leg Glute Bridge",target:"glutes",equipment:"body weight",gifUrl:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Single_Leg_Glute_Bridge/0.gif",instructions:["Allongé sur le dos","Une jambe tendue","Pousse la hanche vers le haut"]},
];
