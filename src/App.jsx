      ...
      <div style={{ padding: "0 20px 30px" }}>
        {tab === "clients" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            {clientsLoading ? <Spinner /> : clients.map(client => (
              <Card key={client.id} onClick={() => setSelectedClient(client)} style={{ cursor: "pointer", borderColor: client.paused ? "#fb923c44" : "#2a2a2a" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 12, color: "#888888", marginTop: 2 }}>
                        {client.paused ? <span style={{ color: "#fb923c" }}>⏸ Pause</span> : client.next_payment ? <span style={{ color: daysUntil(client.next_payment) <= 7 ? "#f87171" : "#888888" }}>💳 {formatDate(client.next_payment)}</span> : <span>Active</span>}
                      </div>
                    </div>
                  </div>
                  <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
